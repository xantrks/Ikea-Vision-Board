...
const ImageUploader = forwardRef<HTMLImageElement, ImageUploaderProps>(({ id, label, onFileSelect, imageUrl, isDropZone = false, onProductDrop, persistedOrbPosition, isTouchHovering = false, touchOrbPosition = null }, ref) => {
  ...
  const uploaderClasses = `w-full h-full bg-white border-2 border-dashed rounded-lg flex items-center justify-center transition-all duration-300 relative overflow-hidden ${
  ...
  return (
    <div className="flex flex-col items-center w-full h-full max-w-5xl max-h-[80vh]">
